report 50006 "DK_Reminder 2nd"
{
    RDLCLayout = './src/layout/DKReminder2nd.rdl';
    WordLayout = './src/layout/DKReminder2nd.docx';
    ...
    dataset
    {
        dataitem(DK_Contract; DK_Contract)
        {
            ...
            column(AddRemainingDueDate_Year; Format("Add. Remaining Due Date 1", 0, '<Year4>'))
            {
            }
            column(AddRemainingDueDate_Month; Format("Add. Remaining Due Date 1", 0, '<Month,2>'))
            {
            }
            column(AddRemainingDueDate_Day; Format("Add. Remaining Due Date 1", 0, '<Day,2>'))
            {
            }
            ...
            column(AddPaymentDate2_Year; Format(AddRemainingDueDate, 0, '<Year4>'))
            {
            }
            column(AddPaymentDate2_Month; Format(AddRemainingDueDate, 0, '<Month,2>'))
            {
            }
            column(AddPaymentDate2_Day; Format(AddRemainingDueDate, 0, '<Day,2>'))
            {
            }
            ...
            begin
                ...
                _ReportPrtHisLitigation.InsertPrintingHistory(DK_Contract, DocumentNo, REPORT::"DK_Reminder 2nd",
                                                              EmployeeNo, EmployeeName, EmployeeMobileNo, AddRemainingDueDate);

                "Reminder Date 2" := WorkDate;
                "Add. Remaining Due Date 2" := AddRemainingDueDate;
                Modify;
            end;
