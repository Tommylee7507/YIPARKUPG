report 50008 "DK_Reminder - Notice"
{
    RDLCLayout = './src/layout/DKReminderNotice.rdl';
    WordLayout = './src/layout/DKReminderNotice.docx';
    ...
    dataset
    {
        dataitem(DK_Contract; DK_Contract)
        {
            ...
            column(ComInfor_PhoneNo; ComInfor."Phone No.")
            {
            }
            ...
            begin
                ...
                _ReportPrtHisLitigation.InsertPrintingHistory(DK_Contract, DocumentNo, REPORT::"DK_Reminder - Notice",
