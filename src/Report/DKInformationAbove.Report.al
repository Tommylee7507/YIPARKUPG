report 50004 "DK_Information Above"
{
    RDLCLayout = './src/layout/DKInformationAbove.rdl';
    WordLayout = './src/layout/DKInformationAbove.docx';
    ...
    dataset
    {
        dataitem(DK_Contract; DK_Contract)
        {
            ...
            begin
                ...
                _ReportPrtHisLitigation.InsertPrintingHistory(DK_Contract, DocumentNo, REPORT::"DK_Information Above",
