codeunit 60004 "Opening Batch Daily Admin"
{
    // //ýˆ«Š± Apply €Ë„™ ‘ˆÏ
    ...
    begin
        ...
        FindContract(Today, '20170926004');
        ...
        */
        ...
        //FindRemainingContract_Gen('20120706003');
        /*
        FindRemainingContract_Gen('20131018002');
        FindRemainingContract_Gen('20131112001');
        FindRemainingContract_Gen('20131115002');
        FindRemainingContract_Gen('20131121001');
        FindRemainingContract_Gen('20131127001');
        FindRemainingContract_Gen('20131130010');
        FindRemainingContract_Gen('20131221003');
        */
        ...
        /*
        FindPaymentReceiptApply('20120706003',191001D);
        FindPaymentReceiptApply('20131018002',191001D);
        FindPaymentReceiptApply('20131112001',191001D);
        FindPaymentReceiptApply('20131115002',191001D);
        FindPaymentReceiptApply('20131121001',191001D);
        FindPaymentReceiptApply('20131127001',191001D);
        FindPaymentReceiptApply('20131130010',191001D);
        FindPaymentReceiptApply('20131221003',191001D);
        */
    ...
    begin
        ...
        pContract.SetRange("Date Filter", 0D, sTODAY);
        ...
        if pContract.FindSet then begin
            ...
            repeat
                ...
                if ((pContract."General Expiration Date" <> 0D) and (pContract."General Expiration Date" <= sTODAY)) or
                   ((pContract."Land. Arc. Expiration Date" <> 0D) and (pContract."Land. Arc. Expiration Date" <= sTODAY)) then begin
    ...
    begin
        ...
        if _Contract.FindSet then begin
            ...
            repeat
                ...
                _PayReceiptDoc.SetFilter("Line General Expiration Date", '<>%1&>=%2', 0D, 20190101D);                   //Ÿ‰¦ýˆ«Š±
                ...
                if _PayReceiptDoc.FindSet then begin
                    ...
                    repeat
                        ...
                        if _PayReceiptDoc."Line General Expiration Date" >= 20190101D then begin                //Ÿ‰¦ýˆ«Š±
    ...
    begin
        ...
        if _Contract.FindSet then begin
            ...
            repeat
                ...
                _PayReceiptDoc.SetCurrentKey("Payment Date");
                _PayReceiptDoc.SetRange("Contract No.", _Contract."No.");
                _PayReceiptDoc.SetFilter("Line Land. Arc. Exp. Date", '<>%1&>=%2', 0D, 20190101D);                     //‘†µýˆ«Š±
                _PayReceiptDoc.SetFilter("Posting Date", '<%1', 20190101D);
                _PayReceiptDoc.SetRange(Posted, true);
                if _PayReceiptDoc.FindSet then begin
                    //‚‚Šž…˜ ýˆ«Š±
    ...
    begin
        ...
        //_AdminExpenseLedger.SETRANGE("Contract No.", '20111226003');
